          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="mt-5 flex justify-start items-start flex-col my-2.5 w-full px-1">
              <label
                ...
                htmlFor="name"
              >
                <i class="bx pr-2.5 bxs-user-circle"></i> Enter Your Name
              </label>
              <input
                type="name"
                name="name"
            ...
            <div className="mt-5 flex justify-start items-start flex-col my-2.5 w-full px-1">
              <label
                ...
                htmlFor=""
              >
                <i class="bx bxs-lock pr-2.5"></i> Enter Your Password
              </label>
              <input
                type="password"
                name="password"
            ...
            <h1> Don't have an account yet ? <Link to={'/'}> <span className="text-[#5F6DF8] font-medium" > login</span></Link> </h1>
